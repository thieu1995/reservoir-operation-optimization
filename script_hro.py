#!/usr/bin/env python
# Created by "Thieu" at 00:13, 25/11/2022 ----------%                                                                               
#       Email: nguyenthieu2102@gmail.com            %                                                    
#       Github: https://github.com/thieu1995        %                         
# --------------------------------------------------%

import numpy as np
from src.models.problem import HydropowerReservoirOperationProblem
    ...
    for opt_paras in list(ParameterGrid(system["param_grid"])):
        for ndim in MhaConfig.N_DIMS:
            for idx_trial in range(1, Config.N_TRIALS + 1):
                problem = HydropowerReservoirOperationProblem(lb=[0.] * ndim, ub=[1000.] * ndim, minmax="min", datafile=datafile)
